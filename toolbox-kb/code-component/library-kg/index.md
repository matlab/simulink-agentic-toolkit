...
Common blocks: [common.md](common.md) (1 of 1 blocks)

## Categories

- [Co simulation](co-simulation.md) — 1 blocks; External tool and code integration via co-simulation interfaces
