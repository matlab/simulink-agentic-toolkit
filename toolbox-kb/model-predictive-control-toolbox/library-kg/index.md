...
Common blocks: [common.md](common.md) (4 of 12 blocks)

## Categories

- [Mpc controllers](mpc-controllers.md) — 8 blocks; Model predictive control algorithms for constrained optimal control
- [Automated driving](automated-driving.md) — 4 blocks; Pre-built MPC-based automated driving controllers
