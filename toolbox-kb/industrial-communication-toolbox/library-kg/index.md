...
Common blocks: [common.md](common.md) (4 of 6 blocks)

## Categories

- [Industrial protocols](industrial-protocols.md) — 6 blocks; Industrial communication protocols for automation and IoT
