...
Common blocks: [common.md](common.md) (2 of 4 blocks)

## Categories

- [Opencv interface](opencv-interface.md) — 4 blocks; Data conversion blocks for interfacing Simulink with OpenCV C++ code
